...
layer: overlay
trigger: event in [layoffs, restructuring, site-closure] OR (event in [financial-difficulty, strategy-market-exit, merger-acquisition] AND audiences include an Employees option)
version: 0.3.0
status: draft
