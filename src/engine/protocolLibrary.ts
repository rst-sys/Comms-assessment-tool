...
export const PROTOCOL_LIBRARY: ProtocolFile[] = [
    ...
    },
    {
      ...
      "rests_on": "EU and US law protecting whistleblowers, the EU presumption of innocence (binding on authorities, applied by analogy), US prosecutors' criteria for internal investigations, and research on denial after trust violations.",
      "changelog": [
      ...
      "elements": [
        ...
        },
        {
          ...
          "replaces": [
            ...
            "commercial.employees-in-a-deal"
          ]
        },
        {
