...
rests_on: >-
  EU and US law protecting people who report wrongdoing, the EU presumption of innocence (binding on authorities, applied here by analogy), US prosecutors' criteria for internal investigations, and research on denial after trust violations.
changelog:
...
elements:
  ...
  - id: allegations.protection-for-those-who-report
    ...
    basis_note: "Binding under EU whistleblower law (reporters' identity kept confidential; harm to their reputation counts as retaliation) and, for US listed companies, US law (no retaliation; no impeding reports to the SEC). Applied to all organizations and to public statements as professional judgement."
